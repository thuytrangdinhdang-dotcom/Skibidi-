-- AUTO START / SAFE INITIALIZATION
-- Runs before the existing LoaderV1 code.
local function Startup()
    -- Put legitimate game initialization here.
    -- Example: load configuration, set local flags, or prepare UI state.
end
...
-- ==============================================================================
-- WIND UI LOADER + CONFIG UI
-- ==============================================================================
VX = {} -- global namespace (tiet kiem local slot)
local WindUI = loadstring(game:HttpGet("https://raw.githubusercontent.com/thuytrangdinhdang-dotcom/Skibidi-/refs/heads/main/Main"))()
pcall(function()
    VX.Alurt = loadstring(game:HttpGet("https://raw.githubusercontent.com/thuytrangdinhdang-dotcom/Skibidi-/refs/heads/main/Uiiii"))()
end)

-- Image background configuration
-- Roblox requires the image to be uploaded as an Image/Decal asset first.
-- Replace only this ID with your uploaded version of the supplied reference image.
local MAIN_BACKGROUND_IMAGE = "rbxassetid://127729348105692"
    ...
    User = {
        ...
        Image = (function()
            local ok, img = pcall(function()
                ...
                return game:GetService("Players"):GetUserThumbnailAsync(plr.UserId, Enum.ThumbnailType.HeadShot, Enum.ThumbnailSize.Size420x420)
            end)
...
-- Notify wrapper: AlurtUI first, WindUI fallback
...
-- Config helpers (WindUI has built-in Flag persistence via Folder)
...
-- Notify + safeCallback provided by WindUI header
...
VX.SettingsTab:Button({
    Title = "Save Config (WindUI Folder)",
    Callback = safeCallback(function()
...
pcall(function()
    if WindUI.SetNotificationLower then
